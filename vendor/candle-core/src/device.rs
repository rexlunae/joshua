...
/// Cpu, Cuda, Metal, OpenCL, or Vulkan
#[derive(Debug, Clone)]
pub enum Device {
    Cpu,
...
impl Device {
    ...
    pub fn as_vulkan_device(&self) -> Result<&crate::VulkanDevice> {
        match self {
            ...
            Self::Sycl(_) => crate::bail!("expected a vulkan device, got Sycl"),
        }
    }
    ...
    pub fn get_current_seed(&self) -> Result<u64> {
        match self {
            ...
            Self::Sycl(o) => o.get_current_seed(),
    ...
    pub fn location(&self) -> DeviceLocation {
        match self {
            ...
            Device::Sycl(device) => device.location(),
