...
- [x] AVX-512 backend: 16-lane fused kernels for the k-quants, IQ2_XXS, MXFP4 and Q1_0/Q2_0 (the other i-quants, TQ1_0/TQ2_0 and NVFP4 decode a block at a time into the SIMD dot)
